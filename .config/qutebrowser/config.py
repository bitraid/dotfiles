...
config.bind(',m', 'spawn mpv --ytdl-format="best[height<=?360]/best[height<=?480]/best[height<=?720]/best[height<=?1080]/best" --no-terminal --force-window --keep-open {url}')
...
config.bind(';m', 'hint links spawn mpv --ytdl-format="best[height<=?360]/best[height<=?480]/best[height<=?720]/best[height<=?1080]/best" --no-terminal --force-window --keep-open {hint-url}')
